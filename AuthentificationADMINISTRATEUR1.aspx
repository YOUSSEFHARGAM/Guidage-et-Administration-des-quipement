<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuthentificationADMINISTRATEUR.aspx.cs" Inherits="AuthetificationADMIN" %>
    ...
    <div class="box">
      <h1>Login<asp:TextBox ID="T1" runat="server" BackColor="Black" Font-Names="Andalus" 
          ...
          <asp:ImageButton ID="ImageButton1" runat="server" BorderColor="White" 
              ...
              Width="270px" onclick="ImageButton1_Click" />
        </h1>
