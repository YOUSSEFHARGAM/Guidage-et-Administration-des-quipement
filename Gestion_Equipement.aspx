<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gestion_Equipement.aspx.cs" Inherits="Acceuil" %>
    ...
    <div id="wrap" >
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li><a href="Gestion_Compte.aspx"><i class="icon-columns"></i> Gestion Equipement </a>
                </li>  

                </li>
                <li><a href="Gestion_Compte.aspx"><i class="icon-columns"></i> Gestion Contact </a>
                </li> 
                <li class="panel">
